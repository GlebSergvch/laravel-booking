...
class RoomResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'options' => $options,
            'created_at' => $this->created_at->toIso8601String(), // Формат ISO 8601
            'updated_at' => $this->updated_at->toIso8601String(), // Формат ISO 8601
